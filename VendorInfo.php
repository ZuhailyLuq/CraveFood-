...
// Get Vendor Info
$vendorSql = "SELECT ShopName, Location, OpenHours, FoodType, Description, Image, Latitude, Longitude FROM vendor WHERE VendorID = ?";
...
$foodSql = "SELECT FoodID, FoodName, Price, Description, DietaryTag, Category, Image FROM MENU_FOOD WHERE VendorID = ? AND Status = 'Available'";
$foodStmt = mysqli_prepare($conn, $foodSql);
mysqli_stmt_bind_param($foodStmt, "i", $vendorId);
