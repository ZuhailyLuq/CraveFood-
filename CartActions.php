...
switch ($action) {
    ...
    case 'add':
        ...
        // Fetch food details + vendor info
        $sql = "SELECT mf.FoodID, mf.FoodName, mf.Price, mf.Description, mf.DietaryTag, mf.VendorID, mf.Image, v.ShopName
                FROM MENU_FOOD mf
        ...
        recordCartActivity($conn, $foodId);
        ...
        echo json_encode([
            'success' => true,
            'message' => $food['FoodName'] . ' added to cart.',
