...
<head>
    ...
    <style>
        ...
        .file-upload-label { display:inline-block; padding:10px 20px; background:#f0f0f0; border:2px dashed #aaa; border-radius:8px; cursor:pointer; text-align:center; width:100%; box-sizing:border-box; transition:border-color 0.2s,background 0.2s; }
        .file-upload-label:hover { border-color:#ff2a44; background:#fff5f6; }
        .file-upload-label .upload-icon { font-size:1.5rem; display:block; margin-bottom:4px; }
        .file-upload-label .upload-text { font-size:0.9rem; color:#666; }
